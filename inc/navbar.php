            ...
            <ul class="navbar-nav mr-auto" id="menu-nav">
              ...
              <li class="dropdown-menu-static dropdown-menu-animated dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                  <li><a class="dropdown-item drop" href="uefaintertotokupasi.php">UEFA İNTERTOTO KUPASI <br>
                      (2006-2007)</a></li>
                  <li><a class="dropdown-item drop" href="türkiyekupasi.php">TÜRKİYE KUPASI <br> (2007-2008)</a></li>
                </ul>
              </li>
              <li class="dropdown-menu-static dropdown-menu-animated dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                  <li><a class="dropdown-item drop" href="fikstur.php?ay_id=1">FIKSTÜR</a></li>
                  <li><a class="dropdown-item drop" href="galeri.php">GALERİ</a></li>
                </ul>
              </li>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="pasolig-info.php?info_id=1"> Pasolig</a>
              </li>
            </ul>
            <ul class="navbar-nav" id="ara-nav">
              <form action="arama.php" id="ara-form" method="post">
                <div class="wrapper">
